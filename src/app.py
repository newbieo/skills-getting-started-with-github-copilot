...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for competitive matches and training",
    ...
    "Drama Club": {
        "description": "Perform scenes, build acting skills, and prepare for school productions",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["sophia@mergington.edu", "ryan@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Compete in science challenges and develop STEM problem-solving skills",
